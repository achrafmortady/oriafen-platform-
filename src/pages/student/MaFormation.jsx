      ...
      <div className="card p-6">
        ...
        <div className="space-y-2">
          {unit.chapters.map((ch, i) => {
            ...
            const isAvailable = unit.id === 1 && (i === 0 || i === 1 || i === 2) // Chapitres 1.1, 1.2, 1.3 disponibles
            return (
              <div key={i}
        ...
        {unit.id === 1 && (
          <p style={{ fontSize: 11, color: '#9ca3af', marginTop: 10, fontFamily: 'Montserrat, sans-serif' }}>
            ℹ️ Les chapitres 1.1, 1.2 et 1.3 sont disponibles. Les prochains chapitres seront disponibles progressivement.
          </p>
        )}
      </div>
